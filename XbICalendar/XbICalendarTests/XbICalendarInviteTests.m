...
@interface XbICalendarInviteTests : XbICalendarIcsTest
@end

@implementation XbICalendarInviteTests
...
- (void)test_event_with_sequence
{
    ...
    XCTAssertEqualObjects([vEvent sequences], @[@0], @"Unexpected sequence");
}
